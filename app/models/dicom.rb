class Dicom
 ...
 #dicom map sourced from dicomweb project
 #https://github.com/IntegratorBrad/dicomweb
 ...
 DICOMMAP = JSON.parse('{
  ...
  # returns the dicommap hash
  def self.map
    return DICOMMAP
  end

  # Given name of "PatientName"
  # Return tag will be "00100010"
  def self.name_to_tag(name)
    return DICOMMAP[name]
  end

  # Given tag of "00100010"
  # Return name will be "PatientName"
  def self.tag_to_name(tag)
    return DICOMMAP.invert[tag]
  end
